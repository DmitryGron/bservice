...
const PrivacyContent: React.FC = () => {  
    ...
    return (
      <StyledContextWrapper>
        ...
        <RowWrapper>
          <WideText>
            <h2>6. Datenschutz bei Bewerbungen und im Bewerbungsverfahren</h2>
        ...
        <RowWrapper>
          <LeftText>
            <h2>8. Berechtigte Interessen an der Verarbeitung, die von dem Verantwortlichen oder
        ...
        <RowWrapper>
          <WideText>
            <h2>10. Gesetzliche oder vertragliche Vorschriften zur Bereitstellung der
            ...
            Folgen der Nichtbereitstellung</h2>
