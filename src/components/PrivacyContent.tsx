...
const PrivacyContent: React.FC = () => {
  ...
  return (
    <StyledContextWrapper>
      ...
      <RowWrapper>
        <WideText>
          <Heading>2. Name und Anschrift des für die Verarbeitung Verantwortlichen</Heading>
          ...
          10365 Berlin<br />
          Deutschland<br />
          Tel.: <a href="tel:+015217840168" style={{ textDecoration: 'none', color: 'black' }}>015217840168</a><br />
          E-Mail: <a href="mailto:a.k.buchhaltungsservice@gmail.com" style={{ textDecoration: 'none', color: 'black' }}>a.k.buchhaltungsservice@gmail.com</a><br />
          Website: <a href="https://www.buchhaltung-service.berlin" style={{ textDecoration: 'none', color: 'black' }}>www.buchhaltung-service.berlin</a> <br />
        </WideText>
      </RowWrapper>
      <Divider />
      ...
      <RowWrapper>
        ...
        <RightText>
          ...
          erhobenen Daten und Informationen werden durch die Buchhaltung Service Berlin
      ...
      <RowWrapper>
        <LeftText>
          ...
          &#9702; die Empfänger oder Kategorien von Empfängern, gegenüber denen die<br />
      ...
      <RowWrapper>
        <LeftText>
          &#9702; Die personenbezogenen Daten wurden für solche Zwecke erhoben oder auf sonstige
            ...
            stützte, und es fehlt an einer anderweitigen Rechtsgrundlage für die Verarbeitung.<br />
            ...
            Löschung von personenbezogenen Daten, die bei der Buchhaltung Service Berlin
            gespeichert sind, veranlassen möchte, kann sie sich hierzu jederzeit an einen
            Mitarbeiter des für die Verarbeitung
          </LeftText>
        <RightText>
          Verantwortlichen wenden. Der Mitarbeiter der Buchhaltung Service Berlin wird veranlassen,
          dass dem Löschverlangen unverzüglich nachgekommen wird.
          Wurden die personenbezogenen Daten von der Buchhaltung Service Berlin öffentlich
          gemacht und ist unser Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-
          GVO zur Löschung der personenbezogenen Daten verpflichtet, so trifft die
          Buchhaltung Service Berlin unter Berücksichtigung der verfügbaren Technologie und
          ...
          Verarbeitung nicht erforderlich ist. Der Mitarbeiter der Buchhaltung Service Berlin
      ...
      <RowWrapper>
        ...
        <RightText>
          <br />
            ...
            Person die Einschränkung von personenbezogenen Daten, die bei der Buchhaltung
            Service Berlin gespeichert sind, verlangen möchte, kann sie sich hierzu jederzeit an
            einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter
            der Buchhaltung Service Berlin wird die Einschränkung der Verarbeitung
            veranlassen.
          </RightText>
      </RowWrapper>
      <Divider />
      <RowWrapper>
        <WideText>
          ...
          Person jederzeit an einen Mitarbeiter der Buchhaltung Service Berlin wenden.
          </WideText>
      </RowWrapper>
      <Divider />
      <RowWrapper>
        <WideText>
          <b>g) Recht auf Widerspruch</b><br />
            ...
            <p />
            Die Buchhaltung Service Berlin verarbeitet die personenbezogenen Daten im Falle
            des Widerspruchs nicht mehr, es sei denn, wir können zwingende schutzwürdige
            Gründe für die Verarbeitung nachweisen, die den Interessen, Rechten und Freiheiten
            der betroffenen Person überwiegen, oder die Verarbeitung dient der
            Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen.
            <p />
            Verarbeitet die Buchhaltung Service Berlin personenbezogene Daten, um
            ...
            der Buchhaltung Service Berlin der Verarbeitung für Zwecke der Direktwerbung, so
            wird die Buchhaltung Service Berlin die personenbezogenen Daten nicht mehr für
            ...
            personenbezogener Daten, die bei der Buchhaltung Service Berlin zu
            ...
            jeden Mitarbeiter der Buchhaltung Service Berlin oder einen anderen Mitarbeiter
      ...
      <RowWrapper>
        <WideText>
          <b>h) Automatisierte Entscheidungen im Einzelfall einschließlich Profiling</b><br />
            ...
            Buchhaltung Service Berlin angemessene Maßnahmen, um die Rechte und
      ...
      <RowWrapper>
        <WideText>
          <Heading>6. Datenschutz bei Bewerbungen und im Bewerbungsverfahren</Heading>
            ...
            entgegenstehen. Sonstiges berechtigtes Interesse in diesem Sinne ist beispielsweise
      ...
      <RowWrapper>
        <WideText>
          <Heading>7. Rechtsgrundlage der Verarbeitung</Heading>
      ...
      <RowWrapper>
        <LeftText>
          <Heading>8. Berechtigte Interessen an der Verarbeitung, die von dem Verantwortlichen oder
            einem Dritten verfolgt werden</Heading>
          <p />
        ...
        <RightText>
          <Heading>9. Dauer, für die die personenbezogenen Daten gespeichert werden</Heading>
      ...
      <RowWrapper>
        <WideText>
          <Heading>10. Gesetzliche oder vertragliche Vorschriften zur Bereitstellung der
          ...
          der betroffenen Person, die personenbezogenen Daten bereitzustellen; mögliche
            Folgen der Nichtbereitstellung</Heading>
      ...
      <RowWrapper>
        <WideText>
          <Heading>11. Bestehen einer automatisierten Entscheidungsfindung</Heading>
          ...
          Datenschutzbeauftragter Oberbayern tätig ist, in Kooperation mit dem Anwalt für
          Datenschutz Christian Solmecke erstellt.
         </WideText>
      </RowWrapper>
      <Divider />
    </StyledContextWrapper>
